...
## Install
Download latest version (version 0.3.11, as of 20/03/2020) <a href="https://github.com/lequanglam/c3c/archive/0.3.11.zip">by clicking this</a>, and then extract it. Go to the directory where it extracted (assuming you already opened a terminal), then type: 
```bash
npm install
``` 
