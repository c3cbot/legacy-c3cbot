...
## Install
Install Node.JS (8 or 10, 12 and 13 will not work!) and Git if you don't have one. If you're using Windows, you need to open command prompt and type this command:
```bash
