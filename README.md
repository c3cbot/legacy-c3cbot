...
```
Download latest version (version 0.3.2, as of 11/02/2020) <a href="https://github.com/lequanglam/c3c/archive/0.3.2.zip">by clicking this</a>, and then extract it. Go to the directory where it extracted, then type: 
```bash
npm install
``` 
